...
CREATE INDEX IF NOT EXISTS assistant_channels_user_id_idx
  ON public.assistant_channels (user_id);

CREATE INDEX IF NOT EXISTS messages_assistant_id_idx
  ON public.messages (assistant_id);
