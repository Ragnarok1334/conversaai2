        ...
        <form onSubmit={saveConfig} className="overflow-hidden rounded-3xl border border-card-border bg-card-bg shadow-sm">
          ...
          <div className="grid gap-6 p-6 xl:grid-cols-[1fr_.8fr]">
            <div className="space-y-5">
              <section className="rounded-2xl border border-card-border bg-black/[0.018] p-5">
                ...
                <textarea aria-label="Mensaje de saludo inicial" disabled={!config.welcomeEnabled} value={config.welcomeMessage} onChange={event => setConfig(current => ({ ...current, welcomeMessage: event.target.value }))} maxLength={500} rows={3} className="dashboard-input w-full resize-none rounded-xl border-2 border-brand-violet/20 bg-card-bg p-3 text-sm shadow-sm outline-none transition placeholder:text-text-soft focus:border-brand-violet focus:ring-4 focus:ring-brand-violet/10 disabled:cursor-not-allowed disabled:opacity-50" />
              ...
              <section className="rounded-2xl border border-card-border bg-black/[0.018] p-5">
                ...
                <textarea aria-label="Mensaje fuera de horario" disabled={!config.businessHoursEnabled} value={config.awayMessage} onChange={event => setConfig(current => ({ ...current, awayMessage: event.target.value }))} maxLength={700} rows={3} className="dashboard-input w-full resize-none rounded-xl border-2 border-brand-violet/20 bg-card-bg p-3 text-sm shadow-sm outline-none transition focus:border-brand-violet focus:ring-4 focus:ring-brand-violet/10 disabled:cursor-not-allowed disabled:opacity-50" />
                <p className="dashboard-muted mt-1 text-right text-xs">{config.awayMessage.length}/700</p>
              </section>
              ...
              <section className="rounded-2xl border border-card-border bg-black/[0.018] p-5">
                ...
                <textarea aria-label="Mensaje de derivación humana" disabled={!config.handoffEnabled} value={config.handoffMessage} onChange={event => setConfig(current => ({ ...current, handoffMessage: event.target.value }))} maxLength={700} rows={3} className="dashboard-input w-full resize-none rounded-xl border-2 border-brand-violet/20 bg-card-bg p-3 text-sm shadow-sm outline-none transition focus:border-brand-violet focus:ring-4 focus:ring-brand-violet/10 disabled:cursor-not-allowed disabled:opacity-50" />
                <p className="dashboard-muted mt-1 text-right text-xs">{config.handoffMessage.length}/700</p>
              </section>
            </div>
