  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-2xl mx-auto">
      ...
      <p className="text-text-secondary mb-8 text-lg">
        Aquí se integrará la pasarela de pagos (Stripe, MercadoPago, Flow, etc.) para procesar la suscripción de <strong>{plan.priceLabel}</strong> {plan.period}.
      </p>

      <div className="p-6 bg-white/[0.03] border border-white/10 rounded-2xl w-full text-left mb-8">
        <h3 className="text-white font-medium mb-4">Detalles técnicos para la futura integración (Fase 3):</h3>
        <ul className="list-disc list-inside text-text-soft space-y-2 text-sm">
          ...
          <li>Precio base: <code className="text-brand-cyan">{plan.priceCLP ?? 0} CLP</code></li>
          ...
          <li>Escuchar webhooks de Flow para actualizar <code>status</code> en Supabase.</li>
        </ul>
      </div>
