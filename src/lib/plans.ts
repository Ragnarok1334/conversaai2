...
export const PLAN_CONFIGS: Record<PlanKey, PlanConfig> = {
  ...
  pro: {
    ...
    channels: { webchat: true, telegram: false, whatsapp: true, instagram: false, facebook: true },
    features: [
      '4.000 respuestas de IA',
      '3 asistentes IA',
      '3 dominios autorizados',
      'Web Chat + WhatsApp + Facebook Messenger',
  ...
  business: {
    ...
    label: 'Business',
    priceCLP: 69990,
    prices: { CLP: 69990, USD: 6999 },
    priceLabel: '$69.990 CLP',
    priceLabelCLP: '$69.990 CLP',
    priceLabelUSD: '$69.99 USD',
    period: '/mes',
    description: 'Para equipos o negocios con mayor volumen, múltiples asistentes, analítica y control comercial avanzado.',
